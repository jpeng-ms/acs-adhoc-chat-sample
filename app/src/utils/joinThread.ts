 ...
 */
export const joinThread = async (threadId: string, userId: string, displayName: string, teamsUser: boolean = false): Promise<boolean> => {
  try {
    const requestOptions = {
      ...
      body: JSON.stringify({ Id: userId, DisplayName: displayName, TeamsUser: teamsUser})
    };
